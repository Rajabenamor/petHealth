...
export default function TriagePage() {
  return (
    <main className="min-h-screen bg-stone-50 py-12">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <input className=" mt-8 rounded-2xl border-2 border-stone-200 outline-none focus:border-yellow-600 shadow-sm" />
  ...
  <div className="flex justify-between items-start">
    <div>
      <span className="bg-red-100 text-red-700 text-xs font-bold px-2 py-1 rounded">EMERGENCY</span>
      <h3 className="text-xl font-bold mt-2">Difficulty Breathing</h3>
      <p className="text-stone-600 mt-1">
        If your pet is panting without exercise or has blue-tinted gums, this is a critical emergency.
      </p>
    </div>
